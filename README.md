...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;r^{\mu} = \frac{1}{N\times N}\sum_{i,j} {\mathbf{U}}_{ij}" title="\Large r^{\mu} = \frac{1}{N\times N}\sum_{i,j} {\mathbf{U}}_{ij}" />
